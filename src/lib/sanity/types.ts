...
/**
 * Type brut du contenu de page renvoyé par ROOM_RENTAL_PAGE_QUERY.
 *
 * Les ancres des salles y sont déjà des chaînes : la projection extrait
 * `slug.current`.
 */
export type SanityRoomRentalPageResult = ROOM_RENTAL_PAGE_QUERY_RESULT;
