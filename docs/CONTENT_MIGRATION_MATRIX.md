...
| Nos services               | `/nos-services/`                                   | Regrouper dans une page canonique                | Haute    | Présentation pastorale générale et contact humain            | Révision périodique des procédures, documents, délais, tarifs, horaires, responsables et paiements     | Page canonique typée; anciennes routes en alias `noindex`           |
...
| Location de salle          | `/nos-services/#location-de-salle`                 | Fusionner; confirmation nécessaire               | Haute    | Processus manuel, demande d’information et contrat           | Espaces, capacités, équipements, usages, tarifs, durées, heures, permis, dépôt et disponibilité        | Section intégrée; aucun formulaire ni réservation automatique       |
