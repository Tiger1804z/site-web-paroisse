...
| 9. Galerie immersive    | `Home.tsx`, section 9  | Fond papier; titre et CTA; composition photographique centrée à cinq niveaux                                                                                                                                                              | Six photographies réelles sans personne reconnaissable, sélectionnées depuis `galleryItems`                            | `HomeGallery.astro`         | Cinq images sur desktop; image centrale et voisines partielles sur mobile                                                                | Divergence S1-T12 : carrousel manuel sans autoplay, cadre éditorial, transition plus fluide, titre et description synchronisés sous l’image centrale, lightbox `<dialog>` accessible. Sans JavaScript, la bande horizontale et les liens directs restent disponibles. La page Galerie autonome est différée.                                                                                        |
| 10. Visite et contact   | `Home.tsx`, section 10 | Fond ivoire; titre centré; grille 1:1; quatre panneaux d’information, un panneau secrétariat sur deux colonnes et un espace carte de 420 px; CTA                                                                                          | `eglise-exterieur-identification-01.webp`                                                                              | `VisitSection.astro`        | Une colonne avant 1024 px; adresse et photographie se répondent dès 1024 px                                                              | Divergence S1-T12 : composition éditoriale bourgogne alimentée par `PublicContactDetails`; adresse, téléphone, lien Contact et itinéraire confirmés. Le courriel et les heures non confirmés restent masqués.                                                                                                                                                                                       |
| 11. Footer              | `App.tsx`              | Identité, navigation, coordonnées, réseaux sociaux, mentions et barre d’actions mobile                                                                                                                                                    | Aucune                                                                                                                 | `Footer.astro` existant     | Composition globale déjà migrée dans S1-T01                                                                                              | S1-T12 remplace les placeholders par l’adresse, le téléphone et l’itinéraire issus de `siteSettingsData`, sans créer de courriel ni d’horaire.                                                                                                                                                                                                                                                      |
