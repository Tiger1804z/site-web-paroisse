...
| 6. Vie paroissiale      | `Home.tsx`, section 6  | Fond papier; titre centré; quatre panneaux verticaux 3:4 avec image, overlay et texte en bas; deux colonnes mobile, quatre dès 768 px; CTA centré                                                                                         | Quatre images intérieures réutilisées par Figma                                                                        | `ParishLifePreview.astro`   | 2 colonnes sur mobile; 4 à partir de 768 px; descriptions masquées sur petit écran dans Figma                                            | Aucune photographie ne montre réellement les groupes. Employer des images architecturales neutres et l’indiquer dans le contenu accessible/documentaire.                                                        |
| 7. Feuillet paroissial  | `Home.tsx`, section 7  | Fond bourgogne; deux arcs décoratifs 600 × 300 et 400 × 200 px; grille 1:1; texte, encadré de feuillet, deux CTA; maquette de document 260 × 340 px avec carte décalée                                                                    | Aucune photographie                                                                                                    | `ParishBulletin.astro`      | Une colonne avant 1024 px; illustration de document masquée sous 1024 px                                                                 | Aucun PDF réel: le CTA principal est ajusté vers « Consulter les feuillets » et pointe vers la route existante.                                                                                                 |
| 8. Friperie et location | `Home.tsx`, section 8  | Fond ivoire; titre centré; deux panneaux égaux, papier puis charbon; padding 32/40 px; SVG de 48 px; quart de cercle décoratif; liens éditoriaux                                                                                          | Aucune                                                                                                                 | `PracticalServices.astro`   | Une colonne avant 768 px, deux colonnes ensuite                                                                                          | Les panneaux deviennent des liens sémantiques complets; aucune boutique, réservation ou formulaire.                                                                                                             |
| 9. Galerie immersive    | `Home.tsx`, section 9  | Fond papier; padding vertical 80 px; titre et CTA; bande horizontale défilante de six images; largeurs 256/288 px; ratios alternés 4:3 et 3:4; gap 12 px                                                                                  | Les six photos intérieures du prototype                                                                                | `HomeGallery.astro`         | Défilement horizontal continu; padding de départ 20/40/80 px                                                                             | Conserver le défilement natif et les ratios; pas de lightbox ni carrousel JavaScript.                                                                                                                           |
...
9. Le hero statique devient une rotation artistique de trois images au maximum:
   première image rouge, cadence de 8 secondes, fondu de 1,4 seconde et zoom
   maximal de 1,03. Les indicateurs permettent une sélection manuelle et
...
- le hero avance automatiquement de l’image 1 à l’image 2 après 8 secondes,
