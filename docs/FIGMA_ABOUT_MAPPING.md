...
| Histoire et repères  | bloc `Histoire`                            | Fond papier; grille 1 colonne puis 2 colonnes; texte et diptyque portrait décalé de 32 px                                         | Fondation, construction, évolution et consécration, tous assortis de statuts éditoriaux internes | `20210319_165026_-_Copy.jpg`, `20210331_183200_-_Copy.jpg` | `ParishHistory.astro`     | Écart 48 px mobile, 80 px desktop; diptyque empilé avant 640 px                          | Les repères forment une liste sémantique compacte dans la colonne de texte. La plaque remplace une image Figma afin de documenter la consécration sans section supplémentaire. |
