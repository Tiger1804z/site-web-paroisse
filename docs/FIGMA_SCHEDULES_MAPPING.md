...
| Feuillet                           | `Horaires.tsx`, « Feuillet CTA »                                                | Panneau bourgogne de 360 px; eyebrow doré; H3 ivoire; semaine en texte atténué; CTA clair pleine largeur                                                                        | Libellé, titre, période et lien Feuillets                      | `ScheduleSidebar.astro`                                                   | Pleine largeur sous 1024 px                                                                                      | Différé dans S1-T10 : la donnée est conservée avec `active: false`; panneau, lien de bannière et FAQ d'archive ne sont plus rendus tant qu'aucun PDF réel n'existe.                                                 |
...
3. Le faux téléchargement du feuillet a d'abord été remplacé par un lien
   honnête, puis ce lien a été masqué dans S1-T10 avec toute promotion de
   l'archive inexistante.
